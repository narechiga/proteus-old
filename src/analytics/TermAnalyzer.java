...
public class TermAnalyzer extends Term { 
	...
	public TermAnalyzer( Term someTerm ) {
		thisTerm = someTerm;
	}

//
	public boolean containsVariables( ArrayList<RealVariable> variables ) {
...
//
	public boolean termIsLinearInVariables( ArrayList<RealVariable> variables ) throws AnalyticsException {
