...
%language "Java"
%define package hephaestos.languages.scalarscalarterm;
...
scalarterm:
	...
	| IDENTIFIER LPAREN argumentlist RPAREN {
		try {
			$$ = new ScalarGenericFunctionTerm( new Operator( (String)$1, ((ArrayList<ScalarTerm>)$3).size(), false ), (ArrayList<ScalarTerm>)$3 );
		} catch ( Exception e ) {
