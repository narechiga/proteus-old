...
public abstract class FOLFormula extends dLStructure {
...
// All subclasses need to implement this guy
	...
	public abstract FOLFormula substituteConcreteValuation( Valuation substitution );

// Logic
	public abstract FOLFormula negate();
	...
	public ArrayList<FOLFormula> splitOnAnds () {
                ArrayList<FOLFormula> subFormulas = new ArrayList<FOLFormula>();
        ...
        public FOLFormula universalClosure() {
        	FOLFormula uC;
        ...
        public FOLFormula existentialClosure() {
        	FOLFormula eC;
        	if ( this.isClosedFormula() ) {
        		eC = this;
		} else {
