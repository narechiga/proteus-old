...
public class ImpliesFormula extends FOLFormula {

// Constructor and field getters
	public ImpliesFormula ( FOLFormula antecedent, FOLFormula succedent ) {
	...
	public FOLFormula getAntecedent() {
		return (FOLFormula)(children.get(0));
	}

	public FOLFormula getSuccedent() {
